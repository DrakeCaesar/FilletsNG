...
public:
  ...
  SimpleMsg(BaseListener *listener, const std::string &name) : BaseMsg(listener->getName(), name)
  {
  }

  SimpleMsg(const std::string &listenerName, const std::string &name) : BaseMsg(listenerName, name)
  {
  }
