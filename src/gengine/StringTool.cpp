 ...
 * @return string value
 */
std::string StringTool::toString(long value)
{
...
//-----------------------------------------------------------------
bool StringTool::startsWith(const std::string &str, const std::string &prefix)
{
 ...
 */
void StringTool::replace(std::string &buffer, const std::string &pattern, const std::string &newstring)
{
 ...
 */
StringTool::t_args StringTool::split(const std::string &str, char separator)
{
