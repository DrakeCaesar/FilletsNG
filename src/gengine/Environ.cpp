...
void Environ::store(const Path &file)
{
  ...
  {
    LOG_WARNING(ExInfo("cannot save config").addInfo("file", file.getNative()));
  }
}
//-----------------------------------------------------------------
/**
 ...
 */
void Environ::setParam(const std::string &name, const std::string &value)
{
 ...
 * @param value param value
 */
void Environ::setParam(const std::string &name, long value)
{
 ...
 */
std::string Environ::getParam(const std::string &name, const std::string &implicit) const
{
 ...
 */
int Environ::getAsInt(const std::string &name, int implicit) const
{
 ...
 */
bool Environ::getAsBool(const std::string &name, bool implicit) const
{
  bool result = false;
  std::string value = getParam(name);
 ...
 */
void Environ::addWatcher(const std::string &name, BaseMsg *msg)
{
  m_watchers.insert(std::pair<std::string, BaseMsg *>(name, msg));
  LOG_DEBUG(ExInfo("add watcher").addInfo("param", name).addInfo("msg", msg->toString()));
}
//-----------------------------------------------------------------
/**
