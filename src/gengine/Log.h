...
#define LOG_DEBUG(info)                                       \
    do                                                        \
    {                                                         \
        Log::log(Log::LEVEL_DEBUG, __FILE__, __LINE__, info); \
    } while (false)
#define LOG_INFO(info)                                       \
    do                                                       \
    {                                                        \
        Log::log(Log::LEVEL_INFO, __FILE__, __LINE__, info); \
    } while (false)
#define LOG_WARNING(info)                                       \
    do                                                          \
    {                                                           \
        Log::log(Log::LEVEL_WARNING, __FILE__, __LINE__, info); \
    } while (false)
#define LOG_ERROR(info)                                       \
    do                                                        \
    {                                                         \
        Log::log(Log::LEVEL_ERROR, __FILE__, __LINE__, info); \
    } while (false)
