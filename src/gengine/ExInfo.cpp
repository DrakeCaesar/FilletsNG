 ...
 */
ExInfo::ExInfo(const std::string &problem) throw() : m_what(problem)
{
  /* empty */
}
//-----------------------------------------------------------------
 ...
 * @return *this
 */
ExInfo &ExInfo::addInfo(const std::string &name, const std::string &value) throw()
{
  m_what.append("; ");
  m_what.append(name);
  m_what.append("='");
 ...
 * @return *this
 */
ExInfo &ExInfo::addInfo(const std::string &name, long value) throw()
{
  m_what.append("; ");
  m_what.append(name);
  m_what.append("=");
