...
void VideoAgent::changeVideoMode(int screen_width, int screen_height)
{
  ...
  if (0 == m_window)
  {
    ...
    m_window = SDL_CreateWindow("Fish Fillets", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, screen_width,
                                screen_height, m_fullscreen ? SDL_WINDOW_FULLSCREEN_DESKTOP : 0);
  ...
  SDL_Surface *newScreen =
      SDL_CreateRGBSurface(0, screen_width, screen_height, screen_bpp, 0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF000000);

  m_texture =
      SDL_CreateTexture(m_renderer, SDL_PIXELFORMAT_ARGB8888, SDL_TEXTUREACCESS_STREAMING, screen_width, screen_height);
