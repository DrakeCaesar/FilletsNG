...
//-----------------------------------------------------------------
inline WorldBranch *getWorld(lua_State *L)
{
...
int script_branch_addNode(lua_State *L) throw()
{
  ...
  LevelNode *node = new LevelNode(codename, Path::dataReadPath(datafile), V2(nodeX, nodeY), poster);
...
int script_branch_setEnding(lua_State *L) throw()
{
  ...
  LevelNode *node = new LevelNode(codename, Path::dataReadPath(datafile), V2(-1, -1), poster);
