...
BezierCurve::BezierCurve(double startX, double startY, double controlX1, double controlY1, double controlX2,
                         double controlY2, double endX, double endY)
    : startX(startX), startY(startY), controlX1(controlX1), controlY1(controlY1), controlX2(controlX2),
      controlY2(controlY2), endX(endX), endY(endY)
{
}
...
void initializeBezierMap()
{
  ...
  bezierCurves[make_pair(make_pair(320, 121), make_pair(329, 153))] =
      vector<BezierCurve>{BezierCurve(320, 121, 325.90271, 130.54891, 329.05977, 141.77391, 329, 152.99978)};
  bezierCurves[make_pair(make_pair(329, 153), make_pair(320, 189))] =
      vector<BezierCurve>{BezierCurve(329, 152.99978, 328.93367, 165.45693, 325.00944, 177.59417, 320, 188.99989)};
  bezierCurves[make_pair(make_pair(320, 189), make_pair(301, 224))] =
      vector<BezierCurve>{BezierCurve(320, 188.99989, 314.65701, 201.16505, 308.05118, 212.73858, 301, 224)};
  bezierCurves[make_pair(make_pair(301, 224), make_pair(285, 252))] =
      vector<BezierCurve>{BezierCurve(301, 224, 295.28883, 233.12128, 289.24651, 242.11159, 285, 252.00008)};
  bezierCurves[make_pair(make_pair(285, 252), make_pair(279, 286))] =
      vector<BezierCurve>{BezierCurve(285, 252.00008, 280.41274, 262.68207, 278.00487, 274.41754, 279, 286.00018)};
  bezierCurves[make_pair(make_pair(279, 286), make_pair(292, 315))] =
      vector<BezierCurve>{BezierCurve(279, 286.00018, 279.92782, 296.79938, 284.04766, 307.63524, 292, 315.00027)};
  ...
  bezierCurves[make_pair(make_pair(289, 368), make_pair(257, 397))] =
      vector<BezierCurve>{BezierCurve(289, 368.00044, 277.1817, 376.24671, 268.29134, 388.04625, 257, 397.00051)};
  bezierCurves[make_pair(make_pair(257, 397), make_pair(217, 415))] =
      vector<BezierCurve>{BezierCurve(257, 397.00051, 245.43407, 406.17255, 231.48843, 412.17532, 217, 415.00057)};
  bezierCurves[make_pair(make_pair(217, 415), make_pair(170, 415))] =
      vector<BezierCurve>{BezierCurve(217, 415.00057, 201.56369, 418.67847, 185.08285, 419.93154, 170, 415.00057)};
  ...
  bezierCurves[make_pair(make_pair(289, 368), make_pair(254, 349))] =
      vector<BezierCurve>{BezierCurve(289, 368.00044, 276.12788, 364.33884, 264.08285, 357.80008, 254, 349.00038)};
  bezierCurves[make_pair(make_pair(254, 349), make_pair(226, 317))] =
      vector<BezierCurve>{BezierCurve(254, 349.00038, 243.30592, 339.66723, 234.96499, 328.00482, 226, 317.00028)};
  bezierCurves[make_pair(make_pair(226, 317), make_pair(198, 290))] =
      vector<BezierCurve>{BezierCurve(226, 317.00028, 217.77893, 306.9089, 208.84615, 297.19623, 198, 290.0002)};
  bezierCurves[make_pair(make_pair(198, 290), make_pair(162, 279))] =
      vector<BezierCurve>{BezierCurve(198, 290.0002, 187.36863, 282.94667, 174.74635, 278.43313, 162.00049, 279.00016)};
  ...
  bezierCurves[make_pair(make_pair(292, 315), make_pair(325, 300))] =
      vector<BezierCurve>{BezierCurve(292, 315.00027, 301.40267, 307.18311, 312.92778, 301.9444, 325, 300.00023)};
  bezierCurves[make_pair(make_pair(325, 300), make_pair(359, 304))] =
      vector<BezierCurve>{BezierCurve(325, 300.00023, 336.42482, 298.16031, 348.42543, 299.30021, 359, 304.00024)};
  ...
  bezierCurves[make_pair(make_pair(409, 359), make_pair(414, 387))] =
      vector<BezierCurve>{BezierCurve(408.99999, 359.00041, 412.8146, 367.79454, 414.9853, 377.46495, 414.00002, 387)};
  ...
  bezierCurves[make_pair(make_pair(357, 404), make_pair(343, 369))] =
      vector<BezierCurve>{BezierCurve(357, 403.99999, 348.42118, 394.46176, 343.36585, 381.82343, 343, 369)};
  ...
  bezierCurves[make_pair(make_pair(475, 365), make_pair(510, 360))] =
      vector<BezierCurve>{BezierCurve(475, 365.00042, 486.73974, 367.5188, 499.2177, 365.28294, 510.00001, 360.00041)};
  bezierCurves[make_pair(make_pair(510, 360), make_pair(539, 332))] =
      vector<BezierCurve>{BezierCurve(510.00001, 360.00041, 522.26518, 353.9914, 532.5645, 344.04719, 539, 332.00033)};

  bezierCurves[make_pair(make_pair(279, 286), make_pair(312, 266))] =
      vector<BezierCurve>{BezierCurve(279, 286.00018, 287.30379, 275.84995, 299.15943, 268.66469, 312, 266.00013)};
  bezierCurves[make_pair(make_pair(312, 266), make_pair(350, 265))] =
      vector<BezierCurve>{BezierCurve(312, 266.00013, 324.43564, 263.41959, 337.29943, 264.99268, 350, 265.00012)};
  bezierCurves[make_pair(make_pair(350, 265), make_pair(388, 264))] =
      vector<BezierCurve>{BezierCurve(350, 265.00012, 362.67504, 265.00754, 375.33722, 263.4427, 388, 264)};
  bezierCurves[make_pair(make_pair(388, 264), make_pair(424, 269))] =
      vector<BezierCurve>{BezierCurve(388, 264, 400.11229, 264.53308, 412.04233, 266.99873, 424, 269.00014)};
  ...
  bezierCurves[make_pair(make_pair(285, 252), make_pair(247, 234))] =
      vector<BezierCurve>{BezierCurve(285, 252, 272.07798, 246.56014, 259.39503, 240.55243, 247, 234.00003)};
  bezierCurves[make_pair(make_pair(247, 234), make_pair(219, 217))] =
      vector<BezierCurve>{BezierCurve(247, 234.00003, 237.33841, 228.8926, 227.82943, 223.43995, 219, 216.99997)};
  bezierCurves[make_pair(make_pair(219, 217), make_pair(192, 192))] =
      vector<BezierCurve>{BezierCurve(219, 216.99997, 209.06897, 209.75652, 200.04588, 201.29274, 192, 191.9999)};
  bezierCurves[make_pair(make_pair(192, 192), make_pair(171, 161))] =
      vector<BezierCurve>{BezierCurve(192, 191.9999, 183.80918, 182.53965, 176.60646, 172.1872, 171, 161)};
  bezierCurves[make_pair(make_pair(171, 161), make_pair(161, 125))] =
      vector<BezierCurve>{BezierCurve(171, 161, 165.37494, 149.7757, 161.34415, 137.54992, 161.00049, 124.9997)};
  bezierCurves[make_pair(make_pair(161, 125), make_pair(175, 81))] =
      vector<BezierCurve>{BezierCurve(161.00049, 124.9997, 160.57191, 109.34797, 165.99365, 93.807598, 175, 80.99956)};
  bezierCurves[make_pair(make_pair(175, 81), make_pair(207, 52))] =
      vector<BezierCurve>{BezierCurve(175, 80.99956, 183.33894, 69.140651, 194.61967, 59.542621, 207, 51.99947)};
  ...
  bezierCurves[make_pair(make_pair(244, 44), make_pair(266, 77))] =
      vector<BezierCurve>{BezierCurve(244, 43.999448, 250.67673, 46.201937, 256.34219, 51.039807, 260.07433, 56.998062),
                          BezierCurve(260.07433, 56.998062, 263.80647, 62.956316, 265.6732, 69.976526, 266, 76.999549)};
  bezierCurves[make_pair(make_pair(266, 77), make_pair(251, 115))] =
      vector<BezierCurve>{BezierCurve(266, 76.999549, 266.65222, 91.015879, 261.05011, 105.20792, 251, 114.99966)};

  bezierCurves[make_pair(make_pair(192, 192), make_pair(167, 222))] =
      vector<BezierCurve>{BezierCurve(192, 191.9999, 186.09122, 203.72583, 177.46816, 214.07353, 167, 221.99999)};
  bezierCurves[make_pair(make_pair(167, 222), make_pair(132, 238))] =
      vector<BezierCurve>{BezierCurve(167, 221.99999, 156.6927, 229.80466, 144.63246, 235.24605, 132.0004, 238.00004)};
  ...
  bezierCurves[make_pair(make_pair(167, 222), make_pair(198, 244))] =
      vector<BezierCurve>{BezierCurve(167, 221.99999, 167, 221.99999, 198, 244.00006, 198, 244.00006)};

  bezierCurves[make_pair(make_pair(301, 224), make_pair(340, 228))] =
      vector<BezierCurve>{BezierCurve(301, 224, 313.83645, 226.55084, 326.913, 227.89202, 340, 228)};
  bezierCurves[make_pair(make_pair(340, 228), make_pair(381, 224))] =
      vector<BezierCurve>{BezierCurve(340, 228, 353.75826, 228.11352, 367.54208, 226.86132, 380.99999, 224)};
  ...
  bezierCurves[make_pair(make_pair(456, 189), make_pair(483, 158))] =
      vector<BezierCurve>{BezierCurve(455.99999, 188.99989, 466.78139, 180.38855, 476.49179, 170.16685, 483, 157.9998)};
  bezierCurves[make_pair(make_pair(483, 158), make_pair(491, 119))] =
      vector<BezierCurve>{BezierCurve(483, 157.9998, 489.35435, 146.11841, 492.49897, 132.3899, 491, 118.99968)};
  ...
  bezierCurves[make_pair(make_pair(464, 227), make_pair(487, 252))] =
      vector<BezierCurve>{BezierCurve(463.99999, 227.00001, 469.76451, 236.8187, 478.15395, 244.83173, 487, 252)};
