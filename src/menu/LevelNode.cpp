 ...
 */
LevelNode::LevelNode(const std::string &codename, const Path &datafile, const V2 &loc, const std::string &poster)
 ...
 */
LevelNode *LevelNode::findSelected(const V2 &cursor)
{
 ...
 */
LevelNode *LevelNode::findNextOpen(const LevelNode *current)
{
 ...
 */
LevelNode::t_children LevelNode::findOpenNodes()
{
  t_children opened;
  if (m_state >= STATE_OPEN)
  {
 ...
 */
LevelNode *LevelNode::findNamed(const std::string &codename)
{
...
//-----------------------------------------------------------------
Level *LevelNode::createLevel() const
{
