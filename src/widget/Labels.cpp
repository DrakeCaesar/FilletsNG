...
//-----------------------------------------------------------------
inline Labels *getLabels(lua_State *L)
{
...
//-----------------------------------------------------------------
void Labels::addLabel(const std::string &name, const std::string &lang, const std::string &text)
{
...
//-----------------------------------------------------------------
std::string Labels::getFormatedLabel(const std::string &name, const StringTool::t_args &args) const
{
  std::string result;
  const Dialog *dialog = m_labels->findDialogHard(name);
  if (dialog)
