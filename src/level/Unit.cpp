...
bool Unit::isMoving() const
{
    ...
    if (canDrive())
    {
        ...
        result = action == "move_left" || action == "move_right" || action == "move_up" || action == "move_down" || action == "turn";
    }
    return result;
}
//-----------------------------------------------------------------
...
{
    return m_symbols.getLeft() == symbol || m_symbols.getRight() == symbol || m_symbols.getUp() == symbol || m_symbols.getDown() == symbol;
}
//-----------------------------------------------------------------
/**
