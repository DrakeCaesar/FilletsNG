 ...
 * Create new model.
 */
Cube::Cube(const V2 &location, eWeight weight, eWeight power, bool alive, Shape *new_shape)
 ...
 */
void Cube::setOutDir(Dir::eDir dir, int capacity, eWeight weight)
{
...
std::string Cube::toString() const
{
  return ExInfo("model")
      ...
      .addInfo("shape", m_shape->toString())
      .info();
}
