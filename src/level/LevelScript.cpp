...
void LevelScript::registerGameFuncs()
{
  ...
  m_script->registerFunc("model_change_turnSide", script_model_change_turnSide);
  m_script->registerFunc("model_change_setLocation", script_model_change_setLocation);
  m_script->registerFunc("model_setViewShift", script_model_setViewShift);
  m_script->registerFunc("model_getViewShift", script_model_getViewShift);
  ...
  m_script->registerFunc("model_change_setExtraParams", script_model_change_setExtraParams);
...
void LevelScript::registerLevelFuncs()
{
  ...
  m_script->registerFunc("level_getRestartCounter", script_level_getRestartCounter);
